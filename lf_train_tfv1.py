...
class TrainingLeftRight:
    ...
    def t_gen(self, model):
        ...
        t_generator = test_data.flow_from_directory(directory=self.test_data_path,
                                                       ...
                                                       shuffle=False)
        print(".........Using t_gen.........")
        predictions = model.predict(t_generator)
    ...
    def resnet50(self):
        ...
        model.save_weights('./output/Weights_binary_right_left__resnet50_53k.h5')
        model.save('./output/model_binary_right_left_retina_resnet50_53k.h5')
